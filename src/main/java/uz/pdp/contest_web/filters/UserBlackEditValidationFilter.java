        ...
        if(Objects.isNull(userRole)) {
            if (req.getMethod().equalsIgnoreCase("get")) {
                if (userId == null || userId.isBlank() || !userId.matches("[0-9]+")) {
                    ...
                    RequestDispatcher dispatcher = req.getRequestDispatcher("/views/admin/usersBlackList.jsp");
            ...
            if (req.getMethod().equalsIgnoreCase("post")) {
                if (userStatus == null) {
                    if (blockTill == null && blockCause == null) {
                        ...
                        RequestDispatcher dispatcher = req.getRequestDispatcher("/views/admin/editBlackUser.jsp");
                        dispatcher.forward(req, res);
                    }
