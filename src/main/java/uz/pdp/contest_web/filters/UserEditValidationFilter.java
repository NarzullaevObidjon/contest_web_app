...
@WebFilter(filterName = "UserEditValidationFilter", urlPatterns = "/admin/users/edit")
public class UserEditValidationFilter implements Filter {
        ...
        if(Objects.isNull(userRole)) {
            if (req.getMethod().equalsIgnoreCase("get")) {
                if (userId == null || userId.isBlank() || !userId.matches("[0-9]+")) {
                    ...
                    RequestDispatcher dispatcher = req.getRequestDispatcher("/resources/pages/admin/users.jsp");
            ...
            if (req.getMethod().equalsIgnoreCase("post")) {
                if (userStatus == null) {
                    if (blockTill == null && blockCause == null) {
                        ...
                        RequestDispatcher dispatcher = req.getRequestDispatcher("/resources/pages/admin/editUser.jsp");
                        dispatcher.forward(req, res);
                    }
