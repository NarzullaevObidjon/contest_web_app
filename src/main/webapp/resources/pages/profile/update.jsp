...
<html>
<head>
    <title>Update ${user.getUsername()}</title>
    <jsp:include page="/resources/fragments/css.jsp"/>
</head>
<body>

<h1 class="text-center" style="margin-top: 30px; margin-bottom: 30px">Update User Page</h1>

<form class="row g-3" method="post">
    <div class="col-md-5 offset-1">
        <label for="validationServer01" class="form-label">Username</label>
        <input type="text" class="form-control is-valid" id="validationServer01" name="username"
    ...
    <div class="col-md-4 offset-1">
        ...
        <input type="text" class="form-control is-valid" id="validationServer02" name="firstName"
    ...
    <div class="col-md-5 offset-1">
        ...
        <input type="text" class="form-control" id="validationServer03" name="lastName"
               aria-describedby="validationServer03Feedback"  value="${user.getLastName()}" >
